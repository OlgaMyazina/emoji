...
const EmojiFootprints = forwardRef((props: Props, ref: ForwardedRef<HTMLElement>) => {
  const { ...otherProps } = props

  return (
   <figure ref={ref} {...otherProps}>
      <img
        alt="Emoji-footprints"
...
EmojiFootprints.displayName = 'EmojiFootprints'
EmojiFootprints.defaultProps = {}

export default EmojiFootprints
