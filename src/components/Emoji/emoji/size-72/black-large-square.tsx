...
const EmojiBlackLargeSquare = forwardRef((props: Props, ref: ForwardedRef<HTMLElement>) => {
  const { ...otherProps } = props

  return (
   <figure ref={ref} {...otherProps}>
      <img
        alt="Emoji-black-large-square"
...
EmojiBlackLargeSquare.displayName = 'EmojiBlackLargeSquare'
EmojiBlackLargeSquare.defaultProps = {}
