...
const EmojiWhiteCircle = forwardRef((props: Props, ref: ForwardedRef<HTMLElement>) => {
  const { ...otherProps } = props

  return (
   <figure ref={ref} {...otherProps}>
      <img
        alt="Emoji-white-circle"
...
EmojiWhiteCircle.displayName = 'EmojiWhiteCircle'
EmojiWhiteCircle.defaultProps = {}
